...
Item {
    ...
    property bool isGamenet: false

    signal groupHeaderClicked();

    clip: true
    implicitWidth: 228
    height: (!root.isGamenet ? groupHeader.height : 0) + (root.opened ? groupUserList.height : 0)
        ...
        Item {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    CursorMouseArea {
                        anchors.fill: parent
                        onClicked: MessengerJs.setGroupOpened(root, !root.opened);
                    }
                }
