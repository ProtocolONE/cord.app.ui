...
OverlayBase {
    ...
    Rectangle {
        ...
        AnimatedImage {
            ...
            playing: true
            source: installPath + "Assets/Images/Application/Widgets/Overlay/BS/charactersLoading.gif"
        }
        ...
        AnimatedImage {
            ...
            anchors { centerIn: parent }
            playing: true
            source: installPath + "Assets/Images/Application/Widgets/Overlay/BS/charactersLoadingFail.gif"
        }
        ...
        Image {
            visible: over.isDemonion
                     ...
                     && over.charCount == 0
            anchors.centerIn: parent
            source: installPath + "Assets/Images/Application/Widgets/Overlay/BS/event_only.png"
        }
        ...
        Image {
            ...
            source: installPath + "Assets/Images/Application/Widgets/Overlay/BS/no_char.png"
