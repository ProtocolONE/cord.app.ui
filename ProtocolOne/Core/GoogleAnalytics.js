...
console.log(
    "\n\nWARNIN! Google Analytics `GA` deprecated! Use `Measure Protocol` defined in ProtocolOne\Core\Analytics.js\n\n"
);
...
var referrerPrefix = 'protocolone://launcher';
var referrer;
...
function sendHit(hit) {
    ...
    var options = {
        uri: hit,
        userAgent: 'Launcher/' + applicationVersion + ' ' + systemVersion
    }
